...
uses
  ...
  Data.Bind.DBScope, System.Math, FireDAC.Stan.Intf, FireDAC.Stan.Option,
...
type
  TFrmOutrasEntradas = class(TForm)
    ...
    Q_Consulta_filtroTOTAL_OUTRA: TBCDField;
    Q_Consulta_filtroNUMERO_NOTA_FISCAL: TIntegerField;
    Q_Consulta_filtroSERIE_NOTA_FISCAL: TStringField;
    Q_Consulta_filtroCANCELADA: TIntegerField;
    Q_Consulta_filtroDATA_VENCTO: TDateField;
    QOrdem: TFDQuery;
    ...
    Q_Attualiza_Preco: TFDQuery;
    Q_Attualiza_PrecoCOD_PRO: TIntegerField;
    Q_Attualiza_PrecoCODIGO_BARRA_PRO: TStringField;
    Q_Attualiza_PrecoTP_PRODUTO: TStringField;
    Q_Attualiza_PrecoTP_PRODUCAO: TStringField;
    Q_Attualiza_PrecoESTOQUE_MINIMO: TBCDField;
    Q_Attualiza_PrecoNOME_PRO: TStringField;
    Q_Attualiza_PrecoDESC_CUPOM: TStringField;
    ...
    Q_Attualiza_PrecoPRECO_VAREJO: TBCDField;
    Q_Attualiza_PrecoPRECO_PROMOCAO: TBCDField;
    Q_Attualiza_PrecoPRECO_PRAZO: TBCDField;
    Q_Attualiza_PrecoMARGEM_LUCRO: TBCDField;
    Q_Attualiza_PrecoQUANT_ESTOQ: TBCDField;
    Q_Attualiza_PrecoDATA_VALIDADE: TDateField;
    Q_Attualiza_PrecoDIAS_VALIDADE_PRO: TIntegerField;
    Q_Attualiza_PrecoCONTROLA_ESTOQUE_PRO: TStringField;
    Q_Attualiza_PrecoATIVO_PRO: TStringField;
