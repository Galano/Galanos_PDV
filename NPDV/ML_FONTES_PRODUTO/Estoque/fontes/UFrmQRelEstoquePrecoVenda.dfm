object FrmQRelEstoquePrecoVenda: TFrmQRelEstoquePrecoVenda
  Left = 0
  Top = 0
  Caption = 'FrmQRelEstoquePrecoVenda'
  ClientHeight = 520
  ClientWidth = 834
  Color = clBtnFace
  ...
  object QREstoque: TQuickRep
    ...
    DataSet = DmDados.Q_Produtos_inventario
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        Expression = 'SUM(VL_TOTAL_EM_PROD)'
        Mask = 'R$ ,0.00;R$ -,0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 9
