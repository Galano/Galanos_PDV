...
interface
  Uses Windows, Messages, Sysutils, Classes, Graphics, Dialogs, IniFiles, Db, Forms, StdCtrls, ComCtrls, Mask, DBCtrls, ExtCtrls, Udm, UVendas;
...
begin
    Try
      ...
      inc(linhaCupom);
      Say(linhaCupom,00,LinhaAtual,ArqPrn,Padr('SUB-TOTAL: R$ ' + FrmVendas.lbTotalCom.Caption,ndeColunas));
      inc(linhaCupom);
      Say(linhaCupom,00,LinhaAtual,ArqPrn,Padr('DESCONTO: R$ ' + formatfloat('##,###,##0.00', FrmVendas.EdtDesconto.Value),ndeColunas));
      inc(linhaCupom);
